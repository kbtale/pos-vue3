...
export default {
  ...
  methods: {
    ...
    updateLanguage() {
      this.loading = true;
      this.$axios
        .put('http://192.168.1.186:8000/'+'api/v1/admin/languages/'+this.$route.params.id, {
          headers: {
        ...
        .then((response) => {
          if (this.language.locale === this.defaultLocale) {
            this.$axios.get('http://192.168.1.186:8000/'+'api/v1/admin/languages/'+this.$i18n.locale, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        }).then((response) => {
    ...
    getLanguage() {
      this.loading = true;
      this.$axios
        .get('http://192.168.1.186:8000/'+'api/v1/admin/languages/'+this.$route.params.id, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
    ...
    deleteLanguage() {
      this.$axios
        .delete('http://192.168.1.186:8000/'+'api/v1/admin/languages/'+this.$route.params.id, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
