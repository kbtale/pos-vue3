    ...
    <div class="my-6 max-w-1/6 mx-auto px-4 sm:px-6 lg:px-8">
      <div class="md:flex md:items-center md:justify-between">
        <div class="flex min-w-0">
          <svg-vue class="content-title-icon" :icon="['fas', 'bars-staggered']"></svg-vue>
...
export default {
  ...
  methods: {
    deleteModifierRows() {
      ...
      this.$axios
        .delete('http://192.168.1.186:8000/'+'api/v1/admin/modifiers-rows-destroy/', { rows: this.selectedRows }, {
          headers: {
    ...
    getFoodModifiers() {
      this.loading = true;
      this.$axios
        .get('http://192.168.1.186:8000/'+'api/v1/admin/modifiers/', {
          params: {
            page: this.page,
            sort: this.sort,
