...
export default {
  ...
  methods: {
    getLanguages() {
      this.$axios.get('http://192.168.1.186:8000/'+'api/v1/admin/settings/languages/', {
          headers: {
    ...
    get() {
      this.$axios
        .get('http://192.168.1.186:8000/'+'api/v1/admin/settings/localization/', {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
    ...
    save() {
      this.loading = true;
      this.$axios
        .post('http://192.168.1.186:8000/'+'api/v1/admin/settings/localization/', this.form, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
