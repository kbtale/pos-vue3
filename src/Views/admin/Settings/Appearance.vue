    ...
    <div class="my-6 max-w-1/6 mx-auto px-4 sm:px-6 lg:px-8">
      <div class="md:flex md:items-center md:justify-between">
        <div class="flex min-w-0">
          <svg-vue class="content-title-icon" :icon="['fas', 'palette']"></svg-vue>
...
export default {
  ...
  methods: {
    get() {
      this.$axios
        .get('http://192.168.1.186:8000/'+'api/v1/admin/settings/appearance/', {
          headers: {
    ...
    save() {
      ...
      this.$axios
        .post('http://192.168.1.186:8000/'+'api/v1/admin/settings/appearance/', formData, {
