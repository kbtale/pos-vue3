    ...
    <div class="my-6 max-w-1/6 mx-auto px-4 sm:px-6 lg:px-8">
      <div class="md:flex md:items-center md:justify-between">
        <div class="flex min-w-0">
          <svg-vue class="content-title-icon" :icon="['fas', 'envelope-open-text']"></svg-vue>
...
export default {
  ...
  methods: {
    get() {
      this.$axios
        .get('http://localhost/'+'api/v1/admin/settings/outgoing/mail', {
          headers: {
    ...
    save() {
      this.loading = true;
      this.$axios
        .post('http://localhost/'+'api/v1/admin/settings/outgoing/mail', this.mail, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
