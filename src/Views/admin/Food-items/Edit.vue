...
export default {
  ...
  methods: {
    ...
    getProduct() {
      this.loading = true;
      this.$axios
        .get('http://192.168.1.186:8000/'+'api/v1/admin/food-items/'+this.$route.params.uuid, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
    ...
    deleteProduct() {
      this.$axios
        .delete('http://192.168.1.186:8000/'+'api/v1/admin/food-items/'+this.$route.params.uuid, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`
          }
        })
    ...
    updateProduct() {
      ...
      this.$axios
        .post('http://192.168.1.186:8000/'+'api/v1/admin/food-items/'+this.$route.params.uuid, formData, {
