              ...
              <div class="flex-1 flex flex-col">
                <div class="flex space-x-2 text-left text-xs font-medium text-gray-900">
                  <div class="truncate w-full text-black">
                    ...
                    <ul>
                      <li v-for="(modifier, key) in item.modifiers" class="product-topping flex justify-between text-black">
                  ...
                  <div class="font-semibold text-black h-full border-black border-l w-36">
                    <p class="pl-1 product-topping text-black">{{ item.price }} x {{ item.qty }}</p>
                    <p class="pl-1 product-topping text-black" v-if="item.modifiers_price > 0">{{ item.modifiers_price }}</p>
